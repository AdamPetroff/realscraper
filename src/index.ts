...
async function main(): Promise<void> {
  ...
  const config: Partial<ScraperConfig> = {
    priceMin: process.env.PRICE_MIN ? parseInt(process.env.PRICE_MIN) : undefined,
    priceMax: process.env.PRICE_MAX ? parseInt(process.env.PRICE_MAX) : undefined,
    ...
    roomCount: process.env.ROOM_COUNT ? parseInt(process.env.ROOM_COUNT) : undefined,
  };
